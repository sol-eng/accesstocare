...
This will create a separate subfolder for each example in your current working directory. Currently, there are 12 examples available. You can also specify a target directory:
