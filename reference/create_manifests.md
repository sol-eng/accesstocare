...
Intelligently creates manifest files for Posit Connect deployment. If
the folder contains a primary document, creates a manifest for that
folder. If not, checks subfolders (one level deep) and creates manifests
